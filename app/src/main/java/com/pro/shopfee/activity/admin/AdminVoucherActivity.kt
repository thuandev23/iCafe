...
class AdminVoucherActivity : BaseActivity() {
    ...
    private fun deleteVoucherItem(voucher: Voucher) {
        AlertDialog.Builder(this)
            ...
            .setPositiveButton(getString(R.string.action_ok)) { dialogInterface: DialogInterface?, i: Int ->
    ...
    fun loadListVoucher() {
        ...
        MyApplication[this].getVoucherDatabaseReference()?.addChildEventListener(mChildEventListener!!)
    }

    override fun onDestroy() {
        super.onDestroy()
        mChildEventListener?.let {
            MyApplication[this].getVoucherDatabaseReference()?.addChildEventListener(it)
        }
    }
}