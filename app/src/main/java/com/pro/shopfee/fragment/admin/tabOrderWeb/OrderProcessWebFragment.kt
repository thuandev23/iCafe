...
import com.pro.shopfee.databinding.FragmentOrderProcessWebBinding
import com.pro.shopfee.model.OrderWeb

class OrderProcessWebFragment : Fragment() {
    private var _binding: FragmentOrderProcessWebBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentOrderProcessWebBinding.inflate(inflater, container, false)
        return binding.root
    }
